...
public class AppDbContext : IdentityDbContext
{
    ...
    List<Produto> produtos = new()
    {
        ...
        new Produto(){
            ...
            Descricao = "Entre no Grishaverso: visite, em Ravka, um mundo de magia e superstição, onde nem tudo é o que parece ser! Os três livros da aclamada TrilogiaSombra e ossos – que originou a série da Netflix –, agora reunidos em um box especial",
            Preco = 144.54M,
            Estoque = 23,
            CategoriaId = 1,
        ...
        new Produto(){
            ...
            Descricao = "Notebook 2 Em 1 Positivo Duo C4128b-3 Intel Celeron DualCore Windows11 Home 11,6' - Cinza Escuro - Inclui Microsoft 365* Notebook 2 em 1 Positivo Duo C4128B-3 Intel Celeron Dual Core Windows 11 Home 11,6' - Cinza Escuro",
            Preco = 1439.10M,
            Estoque = 17,
            CategoriaId = 3,
            ...
            Descricao = "Conjunto Mesa De Jantar 6 Lugares Milano Amêndoa Com SavanaConjunto com 6 Cadeiras Milano Conjunto com 6 Cadeiras Milano da Poliman Moveis: nossos modelos de cadeiras sao praticos e resistentes",
            Preco = 521.10M,
            Estoque = 4,
            CategoriaId = 7,
            ...
            Descricao = "O novo Moto G04 foi projetado para impressionar com coresvibrantes, material superior e detalhes lindos. Beleza em alto nível! Feito com material de padrão elevado, é fino e confortável ao toque.",
            Preco = 699M,
            Estoque = 40,
            CategoriaId = 4,
            ...
            Descricao = "Com uma Cervejeira Consul Mais você não precisa mais sepreocupar se suas cervejas vão congelar ou se elas não vão ficar geladas na hora que o pessoal chegar. Você pode mudar a configuração das prateleiras da sua Cervejeira",
            Preco = 2166.03M,
            Estoque = 4,
            CategoriaId = 5,
